...
export interface SalesPlanningSettings {
  bronzeTarget: number;
  silverTarget: number;
  goldTarget: number;
  platinumTarget: number;
  assumedAverageProfit: number;
  assumedSellThroughRate: number;
  assumedListingsPerWeek: number;
}
...
export interface JosSettings {
  ...
  salesPlanning?: SalesPlanningSettings;
